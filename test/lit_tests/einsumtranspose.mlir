...
module {
  func.func @einsum(%arg0 : tensor<2x3xf32>, %arg1 : tensor<4x3x5xf32>) -> tensor<5x4x2xf32> {
    ...
    %2 = "stablehlo.einsum"(%0, %1) {einsum_config = "ba,dbc->cad"} : (tensor<3x2xf32>, tensor<5x4x3xf32>) -> tensor<4x2x5xf32>
...
// CHECK-NEXT:    %0 = "stablehlo.einsum"(%arg0, %arg1) {einsum_config = "ab,cbd->dca"} : (tensor<2x3xf32>, tensor<4x3x5xf32>) -> tensor<5x4x2xf32>
